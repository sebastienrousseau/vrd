...
fn main() {
    ...
    support::task_with_output("Convergence as sample count grows", || {
        let truth = core::f64::consts::PI;
        [10_000usize, 100_000, 1_000_000]
            .iter()
            .map(|&n| {
                let mut rng = Random::from_u64_seed(0x3141_5926_5358_9793);
    ...
    support::task_with_output("Independent runs for variance check", || {
        (0..5)
            .map(|i| {
